...
export default function About(){
  return(
    ...
    <div id="about">
       ...
       <sidebar-l side="right" sideWidth="16rem" > 
       ...
       I am committed to building user-friendly web experiences that are both visually appealing and highly functional. My goal is to combine my technical expertise with my creative vision to develop websites that not only look great but also provide an intuitive and seamless user experience.</p>
        ...
        <box-l padding="0" borderWidth="0">
          <reel-l itemWidth="300px">
              ...
              <img src="src/client/assets/reel_image7_3x.jpg" alt="a descr" loading="lazy" decoding="async"/>
            </picture>
           <frame-l ratio="1:1">
           <picture>
              ...
              <img src="src/client/assets/reel_image6_3x.jpg" alt="a descr" loading="lazy" decoding="async"/>
            </picture>
           </frame-l>
            <picture>
            ...
            <picture>
              ...
              <img src="src/client/assets/reel_image3_3x.jpg" alt="a descr" loading="lazy" decoding="async"/>
            </picture>
            <picture>
              ...
              <img src="src/client/assets/reel_image2_3x.jpg" alt="a descr" loading="lazy" decoding="async"/>
            </picture>
            <picture>
              ...
              <img src="src/client/assets/reel_image1_3x.jpg" alt="a descr" loading="lazy" decoding="async"/>
            </picture>
